      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-neutral-950/80 backdrop-blur-md border-b border-neutral-900">
        <div className="container mx-auto px-6 max-w-6xl h-16 flex items-center justify-between">
          <div className="text-xl font-black text-white tracking-tighter">
            Salman<span className="text-[#bef264]">.</span>
          </div>
          ...
          <a href="#contact" className="px-4 py-2 rounded-lg bg-white text-black font-semibold text-sm hover:bg-neutral-200 transition-all duration-300">
            Hire Me
          </a>
        </div>
      </nav>
